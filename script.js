...
function switchToDark() {
  ...
  container.setAttribute(
    "style",
    "backgroundColor:black;background-image:url('icegif-942.gif'); width: 100%;   height: auto;min-height: 100vh;      background-size: cover;   background-repeat: no-repeat;  background-position: center; "
  );
  modifyBeforeElement(
